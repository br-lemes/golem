...
var myActionBankWithdrawItemCmd = &cobra.Command{
	Use:   "myActionBankWithdrawItem <name>",
	Short: "Action Withdraw Bank Item",
	Long: `Action Withdraw Bank Item
...
Arguments:
  name   Name of your character.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		switch argCount {
		case 1:
			path = fmt.Sprintf("/my/%s/action/bank/withdraw/item", args[0])
		}
