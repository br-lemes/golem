...
var NpcsDetails = newStore(jsonLoader[schemas.NPCSchema](npcsDetails),
	func(item *schemas.NPCSchema) string { return item.Code })

var NpcsItems = newStore(
	func() []schemas.NPCItemSchema {
